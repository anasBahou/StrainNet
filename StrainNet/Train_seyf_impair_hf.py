...
def main():
    ...
    # lr_writer = SummaryWriter(os.path.join(save_path,'lr'))

    # Data loading code
    transform = transforms.Compose([Normalization()])
        
    
    train_set = SpecklesDataset(csv_file='/home/anas/old/anas/speckle_generator/impair_dataset_hf/Train_annotations.csv', root_dir='/home/anas/old/anas/speckle_generator/impair_dataset_hf/Train_Data/', transform = transform)
    test_set = SpecklesDataset(csv_file='/home/anas/old/anas/speckle_generator/impair_dataset_hf/Test_annotations.csv', root_dir='/home/anas/old/anas/speckle_generator/impair_dataset_hf/Test_Data/', transform = transform)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        # # get current lr
        # lr_writer.add_scalar('lr', scheduler.get_lr(), epoch)
