...
class SpecklesDataset(Dataset): 
    ...
    def __getitem__(self, idx):
        ...
        Def_name   = os.path.join('/home/anas/speckle_generator/seyf_dataset_2/', self.Speckles_frame.iloc[idx, 1]) # only the deformation that are recovered from this folder
...
def main():
    ...
    train_set = SpecklesDataset(csv_file='/home/anas/speckle_generator/dataset_5/Train_annotations.csv', root_dir='/home/anas/speckle_generator/dataset_5/', transform = transform)
    test_set = SpecklesDataset(csv_file='/home/anas/speckle_generator/dataset_5/Test_annotations.csv', root_dir='/home/anas/speckle_generator/dataset_5/', transform = transform)
